...
The same config file can mix npm packages and git repositories. Git entries can omit `source` when the package spec is URL-like; npmdata auto-detects them as git.
